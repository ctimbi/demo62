...
a persistence unit "demo62PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demo62/pom.xml":
...
artifact ("demo62.war") is already built. You can build
